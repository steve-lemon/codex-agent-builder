...
const PromptLabLanguageCopySchema = z.object({
    ...
    modePrompt: z.string().min(1),
    settingsPrompt: z.string().min(1),
    ...
    recentRequirementsPrompt: z.string().min(1),
    newRequirementOptionLabel: z.string().min(1),
